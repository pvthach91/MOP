(function($) {
            ...
            if (n.label.length > 0) {
                if (typeof(n) == "object") {
                    if (postion == 0 || n.isdefault == 1) {
                        ...
                        bhtml += '<a class="on" value="' + i + '" href="javascript:void(0)">' + n.title + "</a>";
                        lt_smalllabel({
                            title: n.title,
                            label: n.label
                        })
                    } else {
                        bhtml += '<a value="' + i + '" href="javascript:void(0)">' + n.title + "</a>"
                    }
                }
                postion++
            }
    ...
    var lt_smalllabel = function(opts) {
        ...
        $.each(opts.label, function(i, n) {
            if (typeof(n) == "object") {
                if (i == 0) {
                    html += '<dd class="on"><a id="smalllabel_' + i + '" href="javascript:void(0)">' + n.desc + "</a></dd>";
                    lt_selcountback();
                    $.lt_method_data = {
                        methodid: n.methodid,
                        title: opts.title,
                    ...
                    html += '<dd><a id="smalllabel_' + i + '" href="javascript:void(0)">' + n.desc + "</a></dd>"
                }
            }
        });
        $html = $("<dl>" + html + '</dl><dl style="clear:both;"></dl>');
        ...
        function selectNum(obj, isButton) {
            ...
            if ($.lt_dantuo) {
                if (data_sel[0].length + 1 >= $.lt_danlen && place == 0) {
                    ...
                    $.each($('[name="lt_place_0"][class="on"]'), function(i, n) {
                ...
                if (data_sel[unplace].contains(number)) {
                    $.each($('[name="lt_place_' + unplace + '"][class="on"]'), function(i, n) {
                        if ($(this).html() == number) {
                            $(this).attr("class", "");
