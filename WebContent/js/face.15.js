...
var face = [{
    ...
    label: [{
        ...
        label: [{
            ...
            methodid: 865,
            name: "复式",
            methoddesc: "从万位、千位、百位、十位、个位各选一个号码组成一注。",
            ...
            label:[
                {
                    ...
                    methodid: 1211,
                    name: "重复号",
                    methoddesc: "4条、3条、3带2、两对、一对、全不同号，任选一个即可投注；",
                    methodhelp: "<b>4条：</b>5星中有4星号码相同（其中包括5条），顺序不限，即为中奖。<br>" +
                    		"<b>3条：</b>5星中有3星号码相同，顺序不限，即为中奖（其中包括5条、4条、3条+2条）。<br>" +
                    		"<b>3带2：</b>5星中有3星同号，剩下2星也同号（包括5条），顺序不限，即为中奖。<br>" +
                    		"<b>两对：</b>5星中出现2个双星号，顺序不限，即为中奖（包括5条、4条、3条+2条）。<br>" +
                    		"<b>一对：</b>5星中出现1个双星号，顺序不限，即为中奖（包括5条、4条、3条+2条、2条+2条）<br>。" +
                    		"<b>全不同号：</b>5星中有5个号码全不相同，即为中奖。例如，13248、15768。<br>",
                    methodexample: "<b>4条：</b>例如，30000，01000，…，59999，11111(5条)，…<br>" +
                    		"<b>3条：</b>例如，32000，55000(3条+2条)，01000（4条），…，99999（5条），…<br>" +
                    		"<b>3带2：</b>例如，10001，20200，…,00000（5条）。<br>" +
                    		"<b>两对：</b>例如，12100、00000(5条)、11112(4条)、55522(3条+2条)…<br>" +
                    		"<b>一对：</b>例如，84853、00000(5条)、11112(4条)、55522(3条+2条)、12100(2条+2条)，…<br>" +
                    		"<b>全不同号：</b>例如，13248、15768，…<br>",
                    prize: {
                        1: "1700.00"
                    },
                    dyprize: [],
                ...
                },
                {
                    ...
                    methodid: 1212,
                    name: "顺子号",
                    methoddesc: "顺子，任选一个即可投注；",
                    methodhelp: "<b>顺子：</b>5星号码能给按照顺序连起来，顺序不限，即为中奖。<br>",
                    methodexample: "顺子号，例如， 12345、21354、….；其中67890、78901、90123均不是顺子号",
                    prize: {
                        1: "1700.00"
                    },
                    dyprize: [],
                ...
                },
                {
                    ...
                    methodid: 1213,
                    name: "单双号",
                    methoddesc: "全单、全双、4单1双、1单4双、3单2双、2单3双，任选一个即可投注；",
                    methodhelp: "<b>全单：</b>5星由1、3、5、7、9共5个数字所能组成所有号（不同位数的号可以重复，例如，11375），称为全单号<br>" +
                    		"<b>全双：</b>5星由0、2、4、6、8共5个数字所能组成所有号（不同位数的号可以重复，例如，62220），称为全双号<br>" +
                    		"<b>4单1双：</b>5星由4个单数和1个双数组成号（不同位数的号可以重复，例如，56555），称为4单1双，顺序不限，即为中奖<br>" +
                    		"<b>1单4双：</b>5星由1个单数和4个双数组成号（不同位数的号可以重复，例如，66445），称为1单4双，顺序不限，即为中奖<br>" +
                    		"<b>3单2双：</b>5星由3个单数和2个双数组成号（不同位数的号可以重复，例如，56455），称为3单2双，顺序不限，即为中奖<br>。" +
                    		"<b>2单3双：</b>5星由2个单数和3个双数组成号（不同位数的号可以重复，例如，56445），称为2单3双，顺序不限，即为中奖<br>",
                    methodexample: "<b>全单：</b>例如， 13579、11375（有重复的号）….<br>" +
            		"<b>全双：</b>例如， 02468、 62220（有重复的号）….<br>" +
            		"<b>4单1双：</b>例如， 13578、 56555（有重复的号）….<br>" +
            		"<b>1单4双：</b>例如， 12468、 66445（有重复的号）….<br>" +
            		"<b>3单2双：</b>例如， 13568、 56455（有重复的号）….<br>" +
            		"<b>2单3双：</b>例如， 13468、 56445（有重复的号）….<br>",
                    prize: {
                        1: "1700.00"
                    },
                    dyprize: [],
                ...
                },
                {
                    ...
                    methodid: 1214,
                    name: "大小号",
                    methoddesc: "全大、全小、4大1小、1大4小、3大2小、2大3小，任选一个即可投注；",
                    methodhelp: "<b>全小号：</b>5星由5、6、7、8、9共5个数字所能组成所有号（不同位数的号可以重复，例如，55589），称为全大号<br>" +
                    		"<b>全小号：</b>5星由0、1、2、3、4共5个数字所能组成所有号（不同位数的号可以重复，例如，00120），称为全小号<br>" +
                    		"<b>4大1小：</b>5星由4个大号和1个小号组成号（不同位数的号可以重复，例如，51555），称为4大1小，顺序不限，即为中奖<br>" +
                    		"<b>1大4小：</b>5星由1个大号和4个小号组成号（不同位数的号可以重复，例如，52210），称为1大4小，顺序不限，即为中奖<br>" +
                    		"<b>3大2小：</b>5星由3个大号和2个小号组成号（不同位数的号可以重复，例如，52255），称为3大2小，顺序不限，即为中奖<br>。" +
                    		"<b>2大3小：</b>5星由2个大号和3个小号组成号（不同位数的号可以重复，例如，52215），称为2大3小，顺序不限，即为中奖<br>",
                    methodexample: "<b>全大号：</b>例如， 56789、55589（有重复的号）….<br>" +
            		"<b>全小号：</b>例如， 01234、 00120（有重复的号）….<br>" +
            		"<b>4大1小：</b>例如， 19578、 51555（有重复的号）….<br>" +
            		"<b>1大4小：</b>例如， 13028、 52210（有重复的号）….<br>" +
            		"<b>3大2小：</b>例如， 13578、 52255（有重复的号）….<br>" +
            		"<b>2大3小：</b>例如， 13078、 52215（有重复的号）….<br>",
                    prize: {
                        1: "1700.00"
                    },
                    dyprize: [],
