                                ...
                                for (j = 0; j < data_sel[1].length; j++) {
                                    for (k = 0; k < data_sel[2].length; k++) {
                                        for (L = 0; L < data_sel[3].length; L++) {
                                            if (data_sel[0][i] != data_sel[1][j] && data_sel[0][i] != data_sel[2][k]
                                                &&data_sel[0][i] != data_sel[3][L]&&data_sel[1][j] != data_sel[2][k]&&data_sel[1][j] != data_sel[3][L]&&data_sel[2][k] != data_sel[3][L]) {
                                                nums++
                                            }
                                        }
                                    }
        ...
        function _getcode(issue) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    eval("data=" + data + ";");
                    data.code = data.code.join('').split(',');
                    $.lt_open_status = true;
