...
LZMA = (function() {
    ...
    var _, N8000000000000000_longLit = [0, -9223372036854775808],
    ...
    function $ByteArrayInputStream_0(this$static, buf, off, len) {
        ...
        if (this$static.count > buf.length) this$static.count = buf.length;
        return this$static;
    }
    ...
    function $ensureCapacity(this$static, len) {
        var newbuf;
        if (len <= this$static.buf.length) return;
    ...
    function $configure(this$static, encoder) {
        if (!$SetDictionarySize_0(encoder, 1 << this$static.dictionarySize)) throw $RuntimeException(new RuntimeException(), 'unexpected failure');
        if (!$SetNumFastBytes(encoder, this$static.fb)) throw $RuntimeException(new RuntimeException(), 'unexpected failure');
        if (!$SetMatchFinder(encoder, this$static.matchFinder)) throw $RuntimeException(new RuntimeException(), 'unexpected failure');
        if (!$SetLcLpPb_0(encoder, this$static.lc, this$static.lp, this$static.pb)) throw $RuntimeException(new RuntimeException(), 'unexpected failure');
    }
    ...
    function $init(this$static, input, output, length_0, mode) {
        var encoder, i;
        if (!mode) throw $IllegalArgumentException(new IllegalArgumentException(), 'null mode');
        if (compare(length_0, N1_longLit) < 0) throw $IllegalArgumentException(new IllegalArgumentException(), 'invalid length ' + toString_0(length_0));
    ...
    function $init_0(this$static, input, output) {
        var decoder, hex_length = "",
            i, properties, r, temp_length;
        ...
        for (i = 0; i < properties.length; ++i) {
            r = $read(input);
            console.log("r==========="+r);
            if (r == -1) throw $IOException(new IOException(), 'truncated input');
            properties[i] = r << 24 >> 24;
            console.log("properties[i]==========="+properties[i]);
        }
        decoder = $Decoder(new Decoder());
        if (!$SetDecoderProperties(decoder, properties)) throw $IOException(new IOException(), 'corrupted input');
        ...
        for (i = 0; i < 64; i += 8) {
            ...
            console.log(" hex_length==========="+ hex_length);
        }
        console.log("N1_longLit=========="+ N1_longLit);
        /// Was the length set in the header (if it was compressed from a stream, the length is all f's).
        if (hex_length.toLowerCase() == "ffffffffffffffffff" || hex_length == 0) {
            /// The length is unknown, so set to -1.
            this$static.length_0 = N1_longLit;
            console.log(" this$static.length_0==========="+ this$static.length_0);
        } else {
    ...
    function $GetMatchLen(this$static, index, distance, limit) {
        var i, pby;
        if (this$static._streamEndWasReached) if (this$static._pos + index + limit > this$static._streamPos) limit = this$static._streamPos - (this$static._pos + index); ++distance;
    ...
    function $MoveBlock(this$static) {
        ...
        for (i = 0; i < numBytes; ++i) this$static._bufferBase[i] = this$static._bufferBase[offset + i];
        this$static._bufferOffset -= offset;
    }

    function $MovePos_1(this$static) {
        var pointerToPostion; ++this$static._pos;
        if (this$static._pos > this$static._posLimit) {
            pointerToPostion = this$static._bufferOffset + this$static._pos;
            if (pointerToPostion > this$static._pointerToLastSafePosition) $MoveBlock(this$static);
    ...
    function $ReadBlock(this$static) {
        ...
        while (true) {
            ...
            if (numReadBytes == -1) {
                ...
                if (pointerToPostion > this$static._pointerToLastSafePosition) this$static._posLimit = this$static._pointerToLastSafePosition - this$static._bufferOffset;
                this$static._streamEndWasReached = true;
                return;
            }
            this$static._streamPos += numReadBytes;
            if (this$static._streamPos >= this$static._pos + this$static._keepSizeAfter) this$static._posLimit = this$static._streamPos - this$static._keepSizeAfter;
        }
    }
    ...
    function $clinit_60() {
        ...
        for (i = 0; i < 256; ++i) {
            r = i;
            for (j = 0; j < 8; ++j) if ((r & 1) != 0) r = r >>> 1 ^ -306674912;
            else r >>>= 1;
            CrcTable[i] = r;
        }
    }
    ...
    function $Create_3(this$static, historySize, keepAddBufferBefore, matchMaxLen, keepAddBufferAfter) {
        ...
        if (historySize > 1073741567) return false;
        ...
        if (this$static._cyclicBufferSize != cyclicBufferSize) this$static._son = initDim(_3I_classLit, 0, -1, (this$static._cyclicBufferSize = cyclicBufferSize) * 2, 1);
        hs = 65536;
        if (this$static.HASH_ARRAY) {
            ...
            hs |= 65535;
            if (hs > 16777216) hs >>= 1;
            this$static._hashMask = hs; ++hs;
            hs += this$static.kFixHashSize;
        }
        if (hs != this$static._hashSizeSum) this$static._hash = initDim(_3I_classLit, 0, -1, this$static._hashSizeSum = hs, 1);
        return true;
    }

    function $GetMatches(this$static, distances) {
        var count, cur, curMatch, curMatch2, curMatch3, cyclicPos, delta, hash2Value, hash3Value, hashValue, len, len0, len1, lenLimit, matchMinPos, maxLen, offset, pby1, ptr0, ptr1, temp;
        if (this$static._pos + this$static._matchMaxLen <= this$static._streamPos) lenLimit = this$static._matchMaxLen;
        else {
        ...
        } else hashValue = this$static._bufferBase[cur] & 255 ^ (this$static._bufferBase[cur + 1] & 255) << 8;
        ...
        if (this$static.HASH_ARRAY) {
            ...
            if (curMatch2 > matchMinPos) if (this$static._bufferBase[this$static._bufferOffset + curMatch2] == this$static._bufferBase[cur]) {
                distances[offset++] = maxLen = 2;
                distances[offset++] = this$static._pos - curMatch2 - 1;
            }
            if (curMatch3 > matchMinPos) if (this$static._bufferBase[this$static._bufferOffset + curMatch3] == this$static._bufferBase[cur]) {
        ...
        while (true) {
            ...
            if (this$static._bufferBase[pby1 + len] == this$static._bufferBase[cur + len]) {
                while (++len != lenLimit) if (this$static._bufferBase[pby1 + len] != this$static._bufferBase[cur + len]) break;
                if (maxLen < len) {
    ...
    function $Init_5(this$static) {
        ...
        $ReadBlock(this$static);
        for (i = 0; i < this$static._hashSizeSum; ++i) this$static._hash[i] = 0;
    ...
    function $MovePos_0(this$static) {
        var subValue;
        if (++this$static._cyclicBufferPos >= this$static._cyclicBufferSize) this$static._cyclicBufferPos = 0;
    ...
    function $CopyBlock(this$static, distance, len) {
        ...
        if (pos < 0) pos += this$static._windowSize;
        for (; len != 0; --len) {
            if (pos >= this$static._windowSize) pos = 0;
            this$static._buffer[this$static._pos++] = this$static._buffer[pos++];
            if (this$static._pos >= this$static._windowSize) $Flush_0(this$static);
        }
    }

    function $Create_5(this$static, windowSize) {
        if (this$static._buffer == null || this$static._windowSize != windowSize) this$static._buffer = initDim(_3B_classLit, 0, -1, windowSize, 1);
    ...
    function $Flush_0(this$static) {
        ...
        if (this$static._pos >= this$static._windowSize) this$static._pos = 0;
    ...
    function $processChunk(this$static) {
        var exception;
        if (!this$static.alive) throw new IllegalStateException();
        exception = true;
        try {
            if (this$static.encoder) $processEncoderChunk(this$static);
            else $processDecoderChunk(this$static);
            exception = false;
            return this$static.alive;
        } finally {
            if (exception) this$static.alive = false;
        }
    }
    ...
    function $processDecoderChunk(this$static) {
        ...
        if (result == -1) throw $IOException(new IOException(), 'corrupted input');
        ...
        if ($DecodeBit(this$static.m_RangeDecoder, this$static.m_IsMatchDecoders, (this$static.state << 4) + posState) == 0) {
            ...
            if ($DecodeBit(this$static.m_RangeDecoder, this$static.m_IsRepDecoders, this$static.state) == 1) {
                ...
                if ($DecodeBit(this$static.m_RangeDecoder, this$static.m_IsRepG0Decoders, this$static.state) == 0) {
                    ...
                    if ($DecodeBit(this$static.m_RangeDecoder, this$static.m_IsRepG1Decoders, this$static.state) == 0) distance = this$static.rep1;
                    else {
                        if ($DecodeBit(this$static.m_RangeDecoder, this$static.m_IsRepG2Decoders, this$static.state) == 0) distance = this$static.rep2;
                        else {
                ...
                if (posSlot >= 4) {
                    ...
                    if (posSlot < 14) this$static.rep0 += ReverseDecode(this$static.m_PosDecoders, this$static.rep0 - posSlot - 1, this$static.m_RangeDecoder, numDirectBits);
                    else {
                        this$static.rep0 += $DecodeDirectBits(this$static.m_RangeDecoder, numDirectBits - 4) << 4;
                        this$static.rep0 += $ReverseDecode(this$static.m_PosAlignDecoder, this$static.m_RangeDecoder);
                        if (this$static.rep0 < 0) {
                            if (this$static.rep0 == -1) return 1;
                            return - 1;
                        }
                    }
    ...
    function $Decoder(this$static) {
        ...
        for (i = 0; i < 4; ++i) this$static.m_PosSlotDecoder[i] = $BitTreeDecoder(new BitTreeDecoder(), 6);
        return this$static;
    }
    ...
    function $Init_1(this$static) {
        ...
        for (i = 0; i < 4; ++i) InitBitModels(this$static.m_PosSlotDecoder[i].Models);
    ...
    function $SetDecoderProperties(this$static, properties) {
        ...
        pb = ~~ (remainder / 5);
        dictionarySize = 0;
        for (i = 0; i < 4; ++i) dictionarySize += (properties[1 + i] & 255) << i * 8;
        if (!$SetLcLpPb(this$static, lc, lp, pb)) return false;
    ...
    function $Decode(this$static, rangeDecoder, posState) {
        var symbol;
        if ($DecodeBit(rangeDecoder, this$static.m_Choice, 0) == 0) return $Decode_0(this$static.m_LowCoder[posState], rangeDecoder);
        symbol = 8;
        if ($DecodeBit(rangeDecoder, this$static.m_Choice, 1) == 0) symbol += $Decode_0(this$static.m_MidCoder[posState], rangeDecoder);
        else symbol += 8 + $Decode_0(this$static.m_HighCoder, rangeDecoder);
        return symbol;
    }
    ...
    function $Create_0(this$static, numPosBits, numPrevBits) {
        ...
        for (i = 0; i < numStates; ++i) this$static.m_Coders[i] = $Decoder$LiteralDecoder$Decoder2(new Decoder$LiteralDecoder$Decoder2());
    }
    ...
    function $Init_0(this$static) {
        var i, numStates;
        numStates = 1 << this$static.m_NumPrevBits + this$static.m_NumPosBits;
        for (i = 0; i < numStates; ++i) InitBitModels(this$static.m_Coders[i].m_Decoders);
    }
    ...
    function $DecodeNormal(this$static, rangeDecoder) {
        var symbol;
        symbol = 1;
        do symbol = symbol << 1 | $DecodeBit(rangeDecoder, this$static.m_Decoders, symbol);
        while (symbol < 256);
        return symbol << 24 >> 24;
    }
    ...
    function $DecodeWithMatchByte(this$static, rangeDecoder, matchByte) {
        ...
        do {
            ...
            symbol = symbol << 1 | bit;
            if (matchBit != bit) {
                while (symbol < 256) symbol = symbol << 1 | $DecodeBit(rangeDecoder, this$static.m_Decoders, symbol);
                break;
            }
        } while ( symbol < 256 );
        return symbol << 24 >> 24;
    ...
    function $BaseInit(this$static) {
        ...
        for (i = 0; i < 4; ++i) this$static._repDistances[i] = 0;
    }
    ...
    function $CodeOneBlock(this$static, inSize, outSize, finished) {
        ...
        if (this$static._finished) return;
        ...
        if (eq(this$static.nowPos64, P0_longLit)) {
            ...
            this$static._previousByte = curByte; --this$static._additionalOffset;
            this$static.nowPos64 = add(this$static.nowPos64, P1_longLit);
        }
        if ($GetNumAvailableBytes(this$static._matchFinder) == 0) {
            $Flush(this$static, lowBits_0(this$static.nowPos64));
        ...
        while (true) {
            ...
            if (len == 1 && pos == -1) {
                ...
                if (pos < 4) {
                    ...
                    if (pos == 0) {
                        ...
                        if (len == 1) $Encode_3(this$static._rangeEncoder, this$static._isRep0Long, complexState, 0);
                        else $Encode_3(this$static._rangeEncoder, this$static._isRep0Long, complexState, 1);
                    } else {
                        $Encode_3(this$static._rangeEncoder, this$static._isRepG0, this$static._state, 1);
                        if (pos == 1) $Encode_3(this$static._rangeEncoder, this$static._isRepG1, this$static._state, 0);
                        else {
                    ...
                    if (len == 1) this$static._state = this$static._state < 7 ? 9 : 11;
                    else {
                    ...
                    if (pos != 0) {
                        for (i = pos; i >= 1; --i) this$static._repDistances[i] = this$static._repDistances[i - 1];
                    ...
                    if (posSlot >= 4) {
                        ...
                        if (posSlot < 14) ReverseEncode(this$static._posEncoders, baseVal - posSlot - 1, this$static._rangeEncoder, footerBits, posReduced);
                        else {
                            $EncodeDirectBits(this$static._rangeEncoder, posReduced >> 4, footerBits - 4);
                            $ReverseEncode(this$static._posAlignEncoder, this$static._rangeEncoder, posReduced & 15); ++this$static._alignPriceCount;
                        }
                    }
                    distance = pos;
                    for (i = 3; i >= 1; --i) this$static._repDistances[i] = this$static._repDistances[i - 1];
                    this$static._repDistances[0] = distance; ++this$static._matchPriceCount;
                }
            ...
            if (this$static._additionalOffset == 0) {
                if (this$static._matchPriceCount >= 128) $FillDistancesPrices(this$static);
                if (this$static._alignPriceCount >= 16) $FillAlignPrices(this$static);
    ...
    function $Create_2(this$static) {
        ...
        if (!this$static._matchFinder) {
            ...
            numHashBytes = 4;
            if (this$static._matchFinderType == 0) numHashBytes = 2;
            $SetType(bt, numHashBytes);
            this$static._matchFinder = bt;
        }
        $Create_1(this$static._literalEncoder, this$static._numLiteralPosStateBits, this$static._numLiteralContextBits);
        if (this$static._dictionarySize == this$static._dictionarySizePrev && this$static._numFastBytesPrev == this$static._numFastBytes) return;
    ...
    function $Encoder(this$static) {
        ...
        for (i = 0; i < 4096; ++i) this$static._optimum[i] = new Encoder$Optimal();
        for (i = 0; i < 4; ++i) this$static._posSlotEncoder[i] = $BitTreeEncoder(new BitTreeEncoder(), 6);
        return this$static;
    }

    function $FillAlignPrices(this$static) {
        var i;
        for (i = 0; i < 16; ++i) this$static._alignPrices[i] = $ReverseGetPrice(this$static._posAlignEncoder, i);
    ...
    function $FillDistancesPrices(this$static) {
        ...
        for (lenToPosState = 0; lenToPosState < 4; ++lenToPosState) {
            ...
            st = lenToPosState << 6;
            for (posSlot = 0; posSlot < this$static._distTableSize; ++posSlot) this$static._posSlotPrices[st + posSlot] = $GetPrice_1(encoder, posSlot);
            for (posSlot = 14; posSlot < this$static._distTableSize; ++posSlot) this$static._posSlotPrices[st + posSlot] += (posSlot >> 1) - 1 - 4 << 6;
            st2 = lenToPosState * 128;
            for (i = 0; i < 4; ++i) this$static._distancesPrices[st2 + i] = this$static._posSlotPrices[st + i];
            for (; i < 128; ++i) this$static._distancesPrices[st2 + i] = this$static._posSlotPrices[st + GetPosSlot(i)] + this$static.tempPrices[i];
        }
    ...
    function $GetOptimum(this$static, position) {
        ...
        for (i = 0; i < 4; ++i) {
            ...
            if (this$static.repLens[i] > this$static.repLens[repMaxIndex]) repMaxIndex = i;
        }
        ...
        len = lenEnd;
        do this$static._optimum[len--].Price = 268435455;
        while (len >= 2);
        for (i = 0; i < 4; ++i) {
        ...
        if (len <= lenMain) {
            offs = 0;
            while (len > this$static._matchDistances[offs]) offs += 2;
            for (;; ++len) {
        ...
        cur = 0;
        while (true) {++cur;
            if (cur == lenEnd) return $Backward(this$static, cur);
            ...
            if (this$static._optimum[cur].Prev1IsChar) {--posPrev;
                if (this$static._optimum[cur].Prev2) {
                    state = this$static._optimum[this$static._optimum[cur].PosPrev2].State;
                    if (this$static._optimum[cur].BackPrev2 < 4) state = state < 7 ? 8 : 11;
                    else state = state < 7 ? 7 : 10;
                } else state = this$static._optimum[posPrev].State;
                state = StateUpdateChar(state);
            } else state = this$static._optimum[posPrev].State;
            if (posPrev == cur - 1) {
                if (this$static._optimum[cur].BackPrev == 0) state = state < 7 ? 9 : 11;
            ...
            if (numAvailableBytes > this$static._numFastBytes) numAvailableBytes = this$static._numFastBytes;
            if (!nextIsChar && matchByte != currentByte) {
                ...
                if (lenTest2 >= 2) {
                    ...
                    while (lenEnd < offset) this$static._optimum[++lenEnd].Price = 268435455;
            ...
            for (repIndex = 0; repIndex < 4; ++repIndex) {
                ...
                lenTestTemp = lenTest;
                do {
                    while (lenEnd < cur + lenTest) this$static._optimum[++lenEnd].Price = 268435455;
                ...
                if (lenTest < numAvailableBytesFull) {
                    ...
                    if (lenTest2 >= 2) {
                        ...
                        while (lenEnd < cur + offset) this$static._optimum[++lenEnd].Price = 268435455;
            ...
            if (newLen >= startLen) {
                ...
                while (lenEnd < cur + newLen) this$static._optimum[++lenEnd].Price = 268435455;
                offs = 0;
                while (startLen > this$static._matchDistances[offs]) offs += 2;
    ...
    function $GetPosLenPrice(this$static, pos, len, posState) {
        ...
        lenToPosState = GetLenToPosState(len);
        if (pos < 128) price = this$static._distancesPrices[lenToPosState * 128 + pos];
        else price = this$static._posSlotPrices[(lenToPosState << 6) + GetPosSlot2(pos)] + this$static._alignPrices[pos & 15];
    ...
    function $GetPureRepPrice(this$static, repIndex, state, posState) {
        ...
        if (repIndex == 0) {
            ...
            if (repIndex == 1) price += ProbPrices[this$static._isRepG1[state] >>> 2];
            else {
    ...
    function $Init_4(this$static) {
        ...
        for (i = 0; i < 4; ++i) InitBitModels(this$static._posSlotEncoder[i].Models);
    ...
    function $ReadMatchDistances(this$static) {
        ...
        if (this$static._numDistancePairs > 0) {
            ...
            if (lenRes == this$static._numFastBytes) lenRes += $GetMatchLen(this$static._matchFinder, lenRes - 1, this$static._matchDistances[this$static._numDistancePairs - 1], 273 - lenRes);
    ...
    function $SetDictionarySize_0(this$static, dictionarySize) {
        var dicLogSize;
        if (dictionarySize < 1 || dictionarySize > 536870912) return false;
    ...
    function $SetLcLpPb_0(this$static, lc, lp, pb) {
        if (lp < 0 || lp > 4 || lc < 0 || lc > 8 || pb < 0 || pb > 4) return false;
    ...
    function $SetNumFastBytes(this$static, numFastBytes) {
        if (numFastBytes < 5 || numFastBytes > 273) return false;
    ...
    function $WriteCoderProperties(this$static, outStream) {
        ...
        for (i = 0; i < 4; ++i) this$static.properties[1 + i] = this$static._dictionarySize >> 8 * i << 24 >> 24;
        $write_0(outStream, this$static.properties, 0, 5);
    }

    function $WriteEndMarker(this$static, posState) {
        var lenToPosState;
        if (!this$static._writeEndMark) return;
    ...
    function GetPosSlot(pos) {
        if (pos < 2048) return g_FastPos[pos];
        if (pos < 2097152) return g_FastPos[pos >> 10] + 20;
        return g_FastPos[pos >> 20] + 40;
    }

    function GetPosSlot2(pos) {
        if (pos < 131072) return g_FastPos[pos >> 6] + 12;
        if (pos < 134217728) return g_FastPos[pos >> 16] + 32;
    ...
    function $SetPrices(this$static, posState, numSymbols, prices, st) {
        ...
        for (; i < numSymbols; ++i) prices[st + i] = b1 + $GetPrice_1(this$static._highCoder, i - 8 - 8);
    }
    ...
    function $Create_1(this$static, numPosBits, numPrevBits) {
        ...
        for (i = 0; i < numStates; ++i) this$static.m_Coders[i] = $Encoder$LiteralEncoder$Encoder2(new Encoder$LiteralEncoder$Encoder2());
    }
    ...
    function $Init_3(this$static) {
        var i, numStates;
        numStates = 1 << this$static.m_NumPrevBits + this$static.m_NumPosBits;
        for (i = 0; i < numStates; ++i) InitBitModels_0(this$static.m_Coders[i].m_Encoders);
    }
    ...
    function $Decode_0(this$static, rangeDecoder) {
        var bitIndex, m;
        m = 1;
        for (bitIndex = this$static.NumBitLevels; bitIndex != 0; --bitIndex) m = (m << 1) + $DecodeBit(rangeDecoder, this$static.Models, m);
    ...
    function $Init_8(this$static) {
        ...
        this$static.Code = 0;
        this$static.Range = -1;
        for (i = 0; i < 5; ++i) this$static.Code = this$static.Code << 8 | $read(this$static.Stream);
    }

    function InitBitModels(probs) {
        var i;
        for (i = 0; i < probs.length; ++i) probs[i] = 1024;
    }
    ...
    function $clinit_66() {
        ...
        for (i = 8; i >= 0; --i) {
            ...
            for (j = start; j < end; ++j) ProbPrices[j] = (i << 6) + (end - j << 6 >>> 9 - i - 1);
        }
    }
    ...
    function $EncodeDirectBits(this$static, v, numTotalBits) {
        ...
        for (i = numTotalBits - 1; i >= 0; --i) {
            this$static.Range >>>= 1;
            if ((v >>> i & 1) == 1) this$static.Low = add(this$static.Low, fromInt(this$static.Range));
            if ((this$static.Range & -16777216) == 0) {
                this$static.Range <<= 8;
                $ShiftLow(this$static);
            }
    ...
    function $FlushData(this$static) {
        var i;
        for (i = 0; i < 5; ++i) $ShiftLow(this$static);
    }
    ...
    function encode(s) {
        ...
        for (i = 0; i < s.length; ++i) {
            ch = chars[i];
            if (ch >= 1 && ch <= 127)++elen;
            else if (ch == 0 || ch >= 128 && ch <= 2047) elen += 2;
            else elen += 3;
        }
    ...
    function decompress(byte_arr, callback_num) {
        ...
        byte_arr = new Array(93,0,0,64,0,10,0,0,0,0,0,0,0,0,52,25,73,-18,-114,28,-117,-27,46,52,-128,-86,107,31,-1,-13,-111,64,0);
        console.log('byte_arr:'+byte_arr);
        var this$static = $LZMADemo(new LZMADemo()),
            percent,
