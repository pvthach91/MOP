...
public class JS11X5Bean {
	private String issuecount = "82";
	private String lotteryname="江苏十一选五";
	...
	public JS11X5Bean(){
		...
		userprize = "";
		//参数
		double point = ui.getPoint115();
		int usermode = ui.getModel();
		userprize = makeprize(2,point,usermode);
	}
