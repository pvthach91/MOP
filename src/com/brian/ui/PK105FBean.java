...
import com.brian.item.PKCurScheduleItem;
...
public class PK105FBean {
		private String issuecount = "120";  
		private String lotteryname="pk10";
		private String issueliststr="";  //最近期
		private String servertime = "";
		private String lastopenissue = "";   
		private String curissue = "";
		private int lotteryid = 85;
		private String userprize = ""; //返点
		private CurScheduleItem cursitem = new CurScheduleItem();
		private PKCurScheduleItem pkcursitem = new PKCurScheduleItem();
		public PK105FBean(){
			...
			String winnumber = cursitem.getWinnumber();
			if(winnumber!=null){
				String[] arr = winnumber.split(",");
				pkcursitem.setW1(arr[0]);
				pkcursitem.setW2(arr[1]);
				pkcursitem.setW3(arr[2]);
				pkcursitem.setW4(arr[3]);
				pkcursitem.setW5(arr[4]);
				pkcursitem.setW6(arr[5]);
				pkcursitem.setW7(arr[6]);
				pkcursitem.setW8(arr[7]);
				pkcursitem.setW9(arr[8]);
				pkcursitem.setW10(arr[9]);
			}
			...
			userprize = makeprize(83,point,usermode);
		}
		...
		public PKCurScheduleItem getPkcursitem() {
			return pkcursitem;
		}
		public void setPkcursitem(PKCurScheduleItem pkcursitem) {
			this.pkcursitem = pkcursitem;
		}
