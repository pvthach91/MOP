 ...
 * 2013-12-21
 */
public class JxSSCBean {
	private String issuecount = "84";
	private String lotteryname="江西";
	private String issueliststr="";
	private String servertime = "";
	private String lastopenissue = "";
	private String curissue = "";
	private int lotteryid=6;
	...
	public JxSSCBean(){
		...
		lastopenissue = "{issue:'" + cursitem.getHistoryissue() + "',endtime:'" + et + "',opentime:'" + cursitem.getHisopentime() + "',statuscode:'" + cursitem.getStatus() + "'}";
