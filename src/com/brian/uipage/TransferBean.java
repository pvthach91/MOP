...
import com.brian.item.TransferItem;
...
public class TransferBean extends LogXY{
	...
	private List<TransferItem> reslist = new ArrayList<TransferItem>();
	public TransferBean(){
	...
	public void search(){
		...
		try{
			...
			if("0".equals(flag)){
				...
				reslist = (List<TransferItem>)sblist.get(0);
	...
	public List<TransferItem> getReslist() {
		return reslist;
	}
	public void setReslist(List<TransferItem> reslist) {
