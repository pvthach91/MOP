...
import com.brian.item.WithdrawalItem;
...
public class WithdrawalSearchBean extends LogXY{
	private String stime;
	private String etime;
	private String id;
	private List<WithdrawalItem> reslist = new ArrayList<WithdrawalItem>();
	...
	public void search(){
		...
		if(ui.getUsertype()>=2){
			olist.add("UWithDrawlSearchTest");
		}else{
			olist.add("UWithDrawlSearch");
		}
		...
		try{
			...
			if("0".equals(flag)){
				...
				reslist = (List<WithdrawalItem>)sblist.get(0);
	...
	public List<WithdrawalItem> getReslist() {
		return reslist;
	}
	public void setReslist(List<WithdrawalItem> reslist) {
